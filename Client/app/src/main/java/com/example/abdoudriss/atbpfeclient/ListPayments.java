...
//        json.addProperty("username", LoginCommercant.usrname);
        ...
        Ion.with(ListPayments.this).load(Constants.URL + "historiqueclt.php")
                .setBodyParameter("username", LoginClient.username)
                .asJsonArray()
                            ...
                            if (paiements.isEmpty())
                            {
                                ...
                                builder3.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
                                        Intent it = new Intent(ListPayments.this,MenuClient.class);
                                        startActivity(it);
